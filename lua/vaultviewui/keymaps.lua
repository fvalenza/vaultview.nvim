...
M.generic = {
    ["q"] = { function() require("vaultviewui._commands.open.runner").run_hide() end, mode = "n", noremap = true, nowait = true, },
    ...
    ["0"] = { function() require("vaultviewui._commands.open.runner").run_open_help() end, mode = "n", noremap = true, nowait = true, },
