...
- [Configuration](#configuration)
    ...
    - [Obsdian.nvim integration](#obsdiannvim-integration)
- [Usage](#usage)
...
![img](https://private-user-images.githubusercontent.com/7045681/520424205-befee19f-4130-4a7f-b3d0-1f9e4c01252a.png?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..FnLImYG4RudoxYqAzcwdnMeLcX-ZvXnmhryBj_WMdV0)

#### Boards of Maps Of Content (Columns Layout):
![img](https://private-user-images.githubusercontent.com/7045681/520424264-d91fb855-7543-4583-9ab5-28435808f65c.png?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..oSMUuHhcqWIJPGrKhUfL-Zs8yuoewPfbo-r1k0jbn_s)
...
read- Takes all (or a subset) of your vault’s files => "Input Selection"
...
One can configure a board to use an Obsidian vault configured in the [Obsidian.nvim](https://github.com/obsidian-nvim/obsidian.nvim) plugin by using the special syntax `obsidian:<workspace_name>` in the `vault` field of the board configuration, where `<workspace_name>` is the key of the workspace as defined in the `workspaces` section of obsidian.nvim plugin configuration.
