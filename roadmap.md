Just a bunch of ideas/todo. No priority set yet.

- Better architecture for pagination of VaultData for each board. Currently "hardcoded" in the parsers whereas i should be outside the parser and dependent on the layout configured
- picker functionality
- Jump functionaly ala leap
